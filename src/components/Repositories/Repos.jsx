...
const Repos = () => {
  ...
  if (isLoading) {
    return <div className="repositories-section"><h2>We are setting up things for you...</h2></div>
    
  }

  if (errorEncounter) {
    return <div className="repositories-section"> <h2>Something went wrong! We are unable to get the repository request. Please try again later</h2></div>
  }
    ...
    <section className="repos-section">
      ...
      <div className="repositories-container">
        {repos.map((currentRepo, i) => {
          return (
            <Link to={currentRepo.html_url} target="_blank" className="repo-link">
